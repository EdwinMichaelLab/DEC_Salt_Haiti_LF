...
%
% Date: Dec 5, 2017   CJK
% Recreating a subroutine as a standalone function.
% ________________________________________

function [MfData1, MfData2, MfData3,kId1, kId2] = get_modelFits_Mf_OverallData_child(MfData0,...
...
MidAge = [3 8 13 18 23 28 33 38 43 48 53 58 63 68];
...
for icurve = 1:3 % loop over three types of age curves
    ...
    MfData = getMfAgeProfile_fromLFCurves_child(MfData0(:,2),icurve,OverallMfPrev,ageMthMax/12,demog,MidAge);
