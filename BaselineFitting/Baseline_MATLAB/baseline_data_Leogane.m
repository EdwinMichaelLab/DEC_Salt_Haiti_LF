...
function [ LeoganeMf,LeoganeVol,LeoganeABR,LeoganebCulex]...
    = baseline_data_Leogane
...
%     64.5 10 1 69;
%     74.5 4 0 79]
LeoganeMf = [34.5 100 round(0.159*100) 69];
...
LeoganeVol = 20;  %% simplified into one column

%% Baseline ABR data
% If not available for a particular site, enter value as NaN

LeoganeABR = NaN;  %% simplified into one column


%% Mosquito species flag based on dominant genera (0: Anopheles, 1: Culex)

LeoganebCulex = 1;  %% simplified into one colume,  name change to specy.
